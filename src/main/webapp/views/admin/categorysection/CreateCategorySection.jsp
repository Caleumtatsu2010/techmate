                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="validationform" method="post" action="CreateCategorySection" data-parsley-validate="" novalidate="" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Category Section Name</label>
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input  name="name" type="text" required="" placeholder="Name here!" class="form-control">
                                </div>
                            </div>
